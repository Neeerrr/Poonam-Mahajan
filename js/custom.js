...
const targetSiteVisits = 20552;
const targetMembersSigned = 20239;
const targetComplaintRate = 10697;
const targetworkcop = 5968;
const targetsansad = 38;
const targetsansadii = 13;
const targetsansadiii = 2.5;
const targetsansadiiii = 1.8;
const targetFood = 20327;
const targetvillage = 20945;
const targetdistri = 10587;
const targethelp = 5656;
...
let currenthelp =0;
     ...
     const siteVisitsObserver = new IntersectionObserver((entries) => {
      ...
      function updateCounters() {
        const stepSiteVisits = Math.ceil(targetSiteVisits / 111);
        const stepMembersSigned = Math.ceil(targetMembersSigned / 111);
        const stepComplaintRate = Math.ceil(targetComplaintRate / 111);
        const stepwork = Math.ceil(targetworkcop / 111);
        const stepsansad = Math.ceil(targetsansad / 111);
        const stepsansadii = Math.ceil(targetsansadii / 111);
        const stepsansadiii = targetsansadiii / 111;
        const stepsansadiiii = targetsansadiiii / 111;
        const stepFood = Math.ceil(targetFood / 111);
        const stepvillage = Math.ceil(targetvillage / 111);
        const stephelp = Math.ceil(targethelp / 111);
        const stepdistri = Math.ceil(targetdistri / 111);
